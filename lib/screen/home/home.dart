        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: ListProducts(
              ...
              numberFormat: numberFormat,
              appLocalizations: appLocalizations,
              changeSortOption: ChangeSortOption(0),
            ),
          ),
          SliverToBoxAdapter(
            child: CategoryTitleProduct(
          ...
          SliverToBoxAdapter(
            child: ListProducts(
              ...
              numberFormat: numberFormat,
              appLocalizations: appLocalizations,
              changeSortOption: ChangeSortOption(1),
            ),
          ),
          SliverToBoxAdapter(
            child: CategoryTitleProduct(
          ...
          SliverToBoxAdapter(
            child: ListProducts(
              ...
              numberFormat: numberFormat,
              appLocalizations: appLocalizations,
              changeSortOption: ChangeSortOption(2),
            ),
          ),
          SliverToBoxAdapter(
            child: CategoryTitleProduct(
          ...
          SliverToBoxAdapter(
            child: ListProducts(
              ...
              numberFormat: numberFormat,
              appLocalizations: appLocalizations,
              changeSortOption: ChangeSortOption(3),
            ),
          ),
        ],
      ),
...
class ListProducts extends StatelessWidget {
  ...
  final ChangeSortOption changeSortOption;
  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: 408,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            '${numberFormat.format(state.products[index].previousPrice.toInt())} ${appLocalizations.theCurrency}',
                        ...
                        Text(
                          '${numberFormat.format(state.products[index].price.toInt())} ${appLocalizations.theCurrency}',
                        ),
                      ],
                    ),
                  ),
